    ...
    >
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col items-center justify-center px-10 py-24 text-4xl font-semibold tracking-tight md:py-28 md:text-6xl lg:px-20 lg:py-3 lg:text-7xl">
        <div className="leading-[1.15]">
          <div
            className="introText"
            style={{ opacity: opacityForBlock(progress, 0), color: 'blue' }}
          >
          ...
          <span
            ...
            style={{ opacity: opacityForBlock(progress, 2), color: 'red' }}
          >
            I'm prefer to work on API projects and back-end development.
          </span>
        </div>
      </div>
    </div>
